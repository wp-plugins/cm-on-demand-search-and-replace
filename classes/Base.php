...
class CMODSAR_Base
{
    ...
    public static function cmodsar_admin_menu()
    {
        ...
        add_submenu_page(CMODSAR_SETTINGS_OPTION, 'About', 'About', 'edit_posts', CMODSAR_ABOUT_OPTION, array(self::$calledClassName, 'outputAbout'));
        add_submenu_page(CMODSAR_SETTINGS_OPTION, 'Pro', 'Pro', 'edit_posts', CMODSAR_PRO_OPTION, array(self::$calledClassName, 'outputPro'));
        ...
        {
            $submenu[CMODSAR_SETTINGS_OPTION][999] = array('Yearly membership offer', 'manage_options', self::PAGE_YEARLY_OFFER);
    ...
    public static function admin_head()
    {
        echo '<style type="text/css">
        		#toplevel_page_cmodsar_settings a[href*="cm-wordpress-plugins-yearly-membership"] {color: white;}
    			...
    			#toplevel_page_cmodsar_settings a[href*="cm-wordpress-plugins-yearly-membership"]:before {vertical-align: bottom;}
