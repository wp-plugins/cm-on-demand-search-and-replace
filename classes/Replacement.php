...
class CMODSAR_Replacement
{
    ...
    public static function addSearchAndReplaceReplacementTabContent($content)
    {
        ...
        <div class="block">
            ...
            <p>This plugin allows you to setup the search & replace rules for the content of your content.
            ...
            <p>
                This change does not change the content on the database. Instead it changes the content right before it's displayed.
            </p>
            <?php
